...
OTHEROBJS=main.o queue.o generat.o cpu.o transduc.o trafico.o distri.o com.o linpack.o debug.o
MYOBJS=register.o TrafficLightController.o LightGroupController.o GenericQueue.o IntersectionQueue.o IntersectionController.o TrafficCollector.o

EXAMPLESOBJS=${MYOBJS} ${OTHEROBJS}
LIBNAME=simu
LIBS=-lsimu
...
clean:
	- rm -f ${MYOBJS} simu core simu.exe
